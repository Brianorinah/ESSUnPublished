<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ImprestSurrendersOpen.aspx.cs" Inherits="HRPortal.ImprestSurrendersOpen" %>
    ...
    <div class="row">
        <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Open Imprest Surrenders</li>
            </ol>
        </div>
    </div>
    <%
                ...
                <tbody>
                    <%
                        ...
                        <tr>
                            ...
                            <td><a href="ImprestSurrenders.aspx?step=1&&docNo=<%=arr[0] %>" class="btn btn-info"><i class="fa fa-edit"></i>Edit</a></td>                      
                            <td>
                        <%
                        ...
                        <td>
                            <%
                                ...
                                {
                            %>
                            <a href="ImprestSurrenders.aspx?step=2&&docNo=<%=arr[0] %>" class="btn btn-success">View/Edit</a>
                            <%
                                }                                
                            %>

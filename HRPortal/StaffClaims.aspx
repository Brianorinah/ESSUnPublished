<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StaffClaims.aspx.cs" Inherits="HRPortal.StaffClaims" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <%
                                ...
                                {
                            %>
                            <a href="StaffClaim.aspx?step=1&&docNo=<%=arr[0] %>" class="btn btn-success">View/Edit</a>
